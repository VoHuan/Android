package com.example.knowyourgovernment.AsyncTask;
...
import com.example.knowyourgovernment.MainActivity;
...
public class OfficialLoader extends AsyncTask<String,Void, ArrayList<Official>>
{
    ...
    protected ArrayList<Official> doInBackground(String... strings)
    {
        try{
            ...
            String DATA_URL = "https://www.googleapis.com/civicinfo/v2/representatives?key=AIzaSyDCSAdgJX4pzWf9Tu3nvkBR7lcOiq3w0FI&address="+zip+"";
    ...
    private ArrayList<Official> parseJSON(String data)
    {
        ...
        setUpLocation(data);  //Load dia chi len textview o mainactivity
        ...
        System.out.println(tempList.size()+"hello"+"hello"+"hello"+"hello");
        return  tempList;
    }
...
//            Log.d(TAG, "getPhotoURLfromData: bp: PhotoURL: " + photoURL);
    ...
    private void setUpLocation(String data)  //Load dia chi len tvDiaChi o mainactivity
    {
        TextView location = mainActivity.findViewById(R.id.tvViTriBang);
        try
        {
